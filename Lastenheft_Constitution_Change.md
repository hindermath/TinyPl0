...
```text
Ersetzter Alt-Prompt: speckit-specify Nutze Lastenheft_Constitution_Change.md als verbindliche Eingabedatei. Erstelle die Feature-Spezifikation fuer einen Governance- und Constitution-Abgleich im Repository TinyPl0.
