...
```text
/speckit-specify Nutze Lastenheft_PL0_Optimierung.md als verbindliche Eingabedatei. Erstelle die Feature-Spezifikation fuer einen Optimierungsentscheidungs-Lauf im Repository TinyPl0.
