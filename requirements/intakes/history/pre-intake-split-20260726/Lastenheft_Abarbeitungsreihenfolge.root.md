...
| 6 | `007-ide-l10n` | `Lastenheft_IDE-L10N.md` | Nur den noch offenen IDE-L10N-Teil auf Grundlage der Abschnitte 1 bis 3.2 des historischen Feature-001-Lastenhefts spezifizieren; Core/VM/CLI-L10N bleibt abgeschlossen. | Ein eigener aktiver Intake bewahrt den Archivstatus von Feature 001 und klärt die Ressourcenbasis vor neuen StatusBar-, A11Y- und Editor-Texten. |
...
| `Lastenheft_L10N.001-l10n-backend.md` | Backend-L10N fuer Core/VM/CLI ist abgeschlossen und archiviert. | Als historische Grundlage fuer den neuen aktiven Intake `Lastenheft_IDE-L10N.md` verwenden; nicht erneut starten. |
