...
# Lastenheft IDE PAsm und PCode

## IDE-Erweiterung für Pl0.Ide
- Die IDE-Erweiterung für Pl0.Ide ermöglicht die Integration von P-Assembler und P-Code-Dateien in dim IDE-Quellcode-Editor.
- Wenn P-Assembler oder P-Code im Quellcode-Editor erkannt wird, wird automatisch ein entsprechender Editor-Modus aktiviert, der P-Assembler und P-Code untertützt.
- Quellcode-Formatierung für P-Assembler und P-Code-Dateien
- Einstellungen->Build ertellt den Build-Task für P-Assembler und P-Code-Dateien und das Ergebnis wird direkt im Fenster für den P-Assembler oder P-Code angezeigt mit der gleichen Funktionalität wie bei Pl/0-Quellcode.


## Funktionalitäten
- Die IDE-Erweiterung unterstützt verschiedene Funktionalitäten für die Arbeit mit P-Assembler und P-Code-Dateien.
- Syntax-Highlighting für P-Assembler und P-Code-Dateien
- Fehlerhervorhebung für P-Assembler und P-Code-Dateien
- Code-Vervollständigung für P-Assembler und P-Code-Symbole
...
```text
Ersetzter Alt-Prompt: speckit-specify Nutze requirements/intakes/active/Lastenheft_IDE-Erweiterung-Pl0Ide_PAsm_PCod.md als verbindliche Eingabedatei. Erstelle die Feature-Spezifikation fuer einen IDE-Funktions- und Dokumentationslauf im Repository TinyPl0.
...
```text
$speckit-specify Use requirements/intakes/active/Lastenheft_IDE-Erweiterung-Pl0Ide_PAsm_PCod.md as the binding intake. Preserve its scope, non-goals, ordering, governance, evidence, and acceptance criteria. Create or update only the matching feature specification. Do not implement, commit, push, create a pull request, merge, or start another feature.
```
...
```text
$speckit-autonomous Execute one complete autonomous Spec Kit run using requirements/intakes/active/Lastenheft_IDE-Erweiterung-Pl0Ide_PAsm_PCod.md as the binding intake. Delivery mode: LocalImplementation. Preserve all scope, ordering, security, accessibility, evidence, and acceptance boundaries. Do not push, create or merge a pull request, use bypass authority, expose secrets, or start a follow-up feature.
```
