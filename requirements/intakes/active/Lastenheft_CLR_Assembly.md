...
```text
Ersetzter Alt-Prompt: speckit-specify Nutze requirements/intakes/active/Lastenheft_CLR_Assembly.md als verbindliche Eingabedatei. Erstelle die Feature-Spezifikation fuer einen CLR-Backend-Entscheidungslauf im Repository TinyPl0.
