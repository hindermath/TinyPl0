...
```text
/speckit-specify Nutze Lastenheft_IDE-Erweiterung-Pl0Ide_PAsm_PCod.md als verbindliche Eingabedatei. Erstelle die Feature-Spezifikation fuer einen IDE-Funktions- und Dokumentationslauf im Repository TinyPl0.
