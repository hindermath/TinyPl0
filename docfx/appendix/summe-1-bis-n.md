...
```bash
dotnet run --project src/Pl0.Cli -- examples/appendix/summe-1-bis-n/program.pl0 --list-code
```

P-Code mit Op-Codes anzeigen:

```bash
dotnet run --project src/Pl0.Cli -- examples/appendix/summe-1-bis-n/program.pl0 --list-code --wopcod
```
