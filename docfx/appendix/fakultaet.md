...
[📥 Programm herunterladen](../../examples/appendix/fakultaet/program.pl0)
...
```bash
dotnet run --project src/Pl0.Cli -- examples/appendix/fakultaet/program.pl0 --list-code
```

P-Code mit Op-Codes anzeigen:

```bash
dotnet run --project src/Pl0.Cli -- examples/appendix/fakultaet/program.pl0 --list-code --wopcod
```
