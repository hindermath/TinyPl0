...
- Dieses Repository verwendet ausdrücklich `secure-development-assurance-thirteen-governance-presets`: die bisherigen zwölf Presets plus `secure-development-assurance-governance` v0.1.2, aktiviert mit Priorität 15. Andere Profile und globale Defaults bleiben unverändert.
