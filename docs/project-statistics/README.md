...
sichtbare Aenderungsaktivitaet von TinyPl0. Die
...
- Aus Profil 2 uebernommen: Ausschluss von Release-Please-Manifest, Changelog,
  Paketversionsdatei und IDE-Projektdatei. Diese Dateien enthalten technische
  Liefermetadaten; ihre historischen Ausschluesse bleiben nachvollziehbar.
...
Use UTC and 52 weeks with reference estimates disabled. Preserve the four
legacy release/version exclusions. Do not reinterpret authored phase totals as
...
generierte Ausgaben und verpflichtende IDE-Commitmetadaten committen und beide
...
cutoff. Refresh legacy Profile 2 from the same content revision, commit outputs
and mandatory IDE metadata, and verify both contexts. No dirty-tree bypass or
