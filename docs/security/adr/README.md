...
Sicherheitsbezug fuer TinyPl0. Jede Entscheidung wird als
einzelne Datei im Format `ADR-NNN-titel.md` abgelegt.

*This directory contains security-related architecture decisions
for TinyPl0. Each decision is stored as an individual file
...
[DE-Zusammenfassung: Index der Security Architecture Decision Records fuer TinyPl0.]
-->
