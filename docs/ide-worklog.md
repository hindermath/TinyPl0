...
zugehörigen Abschluss-Commit wurde die IDE-Version ohne Produkt-Build oder
Testlauf auf `1.6.514.72` ausgerichtet.
...
cannot republish. The IDE version was aligned to `1.6.514.72` for the related
closeout commit without a product build or test run.*
