...
supersediert. Für den geplanten Review-PR 78 und seinen Commit 487 wurden die
IDE-Versionsfelder ohne Produkt-Build oder Testlauf auf `1.78.487.42`
...
invalid predecessor was superseded with traceable evidence. For planned review
PR 78 and commit 487, the IDE version fields were aligned to `1.78.487.42`
without a product build or test run; runtime and IDE behavior remain unchanged.*
