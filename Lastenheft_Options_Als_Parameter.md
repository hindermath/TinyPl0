...
```text
/speckit-specify Nutze Lastenheft_Options_Als_Parameter.md als verbindliche Eingabedatei. Erstelle die Feature-Spezifikation fuer einen Options- und Parameterlauf im Repository TinyPl0.
